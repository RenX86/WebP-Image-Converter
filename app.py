...
# Lock for thread-safe access to task_state
...
def start_conversion():
    ...
    def run_script():
        ...
        try:
            ...
            script_path = os.path.join(script_dir, 'WebP-Image-Converter.py')
            cmd = [sys.executable, script_path, folder_path, '-q', str(quality), '-w', str(workers)]
            if keep_originals:
